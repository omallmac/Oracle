    ...
    <center>
        <?php 
            ...
            foreach ($data['results'] as $pokemon) {
                ...
                <img class='pokemon-img' data-url='{$pokemon['url']}' src='https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/{$pokemonId}.png' alt='{$pokemonName}'>
                <br>
